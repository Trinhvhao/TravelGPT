...
class BaseChatConversation(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ChatConversation']] = 'ChatConversation'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ChatConversationActions[_PrismaModelT]':
        from .client import get_client

        return actions.ChatConversationActions[_PrismaModelT](client or get_client(), cls)
