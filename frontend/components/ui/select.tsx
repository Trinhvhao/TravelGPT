...
// ── Vietravel Design System — Select Component ─────────────────────────────
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "border border-light-gray bg-off-white",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-dark-gray ml-2 shrink-0" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className="h-4 w-4 text-dark-gray" />
  </SelectPrimitive.ScrollUpButton>
))
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "border border-light-gray bg-white shadow-elevated",
        "text-[14px] leading-[20px] font-normal text-navy",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-2 pl-8 pr-2 text-[12px] font-semibold text-dark-gray", className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "py-3 pl-10 pr-4 text-[14px] leading-[20px] font-normal text-navy",
      "transition-colors duration-150",
      "outline-none",
      "hover:bg-lightblue hover:text-primary",
      "focus:bg-lightblue focus:text-primary",
